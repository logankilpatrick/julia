...
extern "C" {
    ...
    jl_cgparams_t jl_default_cgparams = {1, 1, 1, 0, 1, jl_default_debug_info_kind, NULL, NULL, NULL, NULL, NULL};
}
    ...
    while (!params.workqueue.empty()) {
        ...
        if (proto_specsig) {
            ...
            if (!preal_specsig) {
                ...
                emit_cfunc_invalidate(protodecl, proto_cc, codeinst->def->specTypes, codeinst->rettype, nrealargs, params, preal);
